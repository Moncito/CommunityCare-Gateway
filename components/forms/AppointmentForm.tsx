    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 flex-2 -mt-8">
                {type === 'create' && <section className="space-y-12">
                    <h1 className="header -mt-10 -mb-5">New Appointment</h1>
                    <p className="text-dark-700 mt-5">Request a new Appointment in 10 Seconds!</p>
                </section>}
                ...
                showTimeSelect
                dateFormat="MM/dd/yyyy  -  h:mm aa" placeholder={""}       
                />
